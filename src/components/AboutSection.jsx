          ...
          <div>
            ...
            >
              <p>
                ...
                Hertfordshire. I've been transforming outdoor spaces for over a
                decade, and I still love every bit of it.
              </p>
              <p>
                There's no team of strangers turning up to your home. When you
                book with Matt's Gardens, you get me — the same friendly face
                every time, with the same commitment to doing a proper job.
              </p>
              <p>
                Whether it's a quick tidy-up or a full garden clearance, I treat
                every garden like my own.
              </p>
            </motion.div>
              ...
              {values.map((v, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-base-content/55 text-sm font-sans">
                      {v.desc}
                    </p>
                  </div>
                </motion.div>
