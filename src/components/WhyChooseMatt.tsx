...
const whyItems = [
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" style={{ width: 24, height: 24 }}>
        <path
          d="M10 1l2.4 4.9 5.4.8-3.9 3.8.9 5.4L10 13.4l-4.8 2.5.9-5.4L2.2 6.7l5.4-.8z"
          stroke="white"
          strokeWidth="1.8"
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" style={{ width: 24, height: 24 }}>
        <path
          d="M12 22s-7-5-7-11a7 7 0 0114 0c0 6-7 11-7 11z"
          stroke="white"
          strokeWidth="1.8"
        />
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" style={{ width: 24, height: 24 }}>
        <path
          d="M20 12V6l-8-4-8 4v6c0 5 8 8 8 8s8-3 8-8z"
          stroke="white"
          strokeWidth="1.8"
          strokeLinejoin="round"
        />
    ...
    <section style={{ background: C.beige, padding: "96px 40px" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          ...
          >
            There are plenty of gardeners out there. Here's why people in
            Hertfordshire keep coming back to Matt.
          </motion.p>
        </div>
            ...
            >
              <div
                style={{
                  ...
                  justifyContent: "center",
                  marginBottom: 18,
                  boxShadow: "0 4px 14px rgba(61,107,44,0.28)",
                }}
              >
                {item.icon}
              </div>
